...
use App\Models\ServidorEfetivoModel;
 ...
 *     description="API Endpoints para gerenciamento de servidores efetivos"
 * )
 */
class ServidorEfetivo extends ResourceController
{
    use ResponseTrait;

    protected ServidorEfetivoModel $servidorEfetivoModel;
    ...
    {
        $this->servidorEfetivoModel = new ServidorEfetivoModel();
    ...
    public function index()
    {
        ...
        $servidores = $this->servidorEfetivoModel->findAll($limit, $offset);
        ...
        $total = $this->servidorEfetivoModel->countAllResults();
     ...
     *         in="path",
     *         required=true,
     *         description="ID do servidor efetivo (mesmo que pes_id)",
    ...
    public function show($id = null)
    {
        ...
        if (!$servidorTransformado) {
            return $this->failNotFound('Erro ao buscar detalhes do servidor efetivo');
        }
     ...
     *         @OA\JsonContent(
     *             required={"pes_nome", "pes_data_nascimento", "pes_sexo", "pes_mae", "servidor_efetivo", "endereco"},
    ...
    public function delete($id = null)
    {
        ...
        try {
            // Excluir o registro de servidor efetivo
            $this->servidorEfetivoModel->delete($id);
     ...
     *     @OA\Response(
     *         response=404,
     *         description="Servidor efetivo não encontrado ou foto não encontrada",
     *         @OA\JsonContent(
     *             @OA\Property(property="error", type="string", example="Servidor efetivo não encontrado")
     *         )
     *     ),
     *     @OA\Response(
     *         response=401,
     ...
     *     @OA\Response(
     *         response=200,
     *         description="Lista de servidores e seus endereços funcionais",
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(
     *                 property="data",
    ...
    public function buscarPorNome()
    {
        ...
        // Consulta para buscar servidores pelo nome e seus respectivos endereços funcionais
        $db = \Config\Database::connect();
        ...
        if (empty($resultado)) {
            return $this->failNotFound('Nenhum servidor encontrado com o nome informado');
        }
    ...
    /**
     * Transforma os dados de um servidor efetivo em um formato padronizado para a API
     *
